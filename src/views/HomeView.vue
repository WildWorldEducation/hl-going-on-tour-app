    ...
    <div v-if="!this.sessionDetailsStore.isAdmin" class="row">
      ...
      <div class="row grid-cards">
        <div id="resumeGameLink" class="grid-card resume-button-outer">
          <a class="resume-button-inner" :href="'/game?resume=' + lastSlide"
            ><span>Resume game</span></a
          >
        </div>
        <div class="grid-card resume-button-outer">
          <router-link
            id="restart-link"
            class="resume-button-inner"
            to="/game?resume=scene1_1"
            ><span>Restart game</span></router-link
          >
        </div>
      </div>
    </div>
    <button
      v-if="!isStudentList && this.sessionDetailsStore.isAdmin"
      @click="showStudentList()"
      class="btn btn-dark showStudentListBtn"
    >
      back
    </button>
    <div class="row">
      <div
        v-if="!this.sessionDetailsStore.isAdmin"
      ...
      <div
        v-if="this.sessionDetailsStore.isAdmin"
        class="col-md-3"
        :class="{ hideStudentList: !isStudentList }"
      >
        <div class="button-row">
          <button
            id="progressButton"
            class="btn btn-dark"
            @click="showStudentProgress()"
          >
            <!-- Eye icon -->
            <svg
      ...
      <div
        :class="{
          'col-md-9': this.sessionDetailsStore.isAdmin,
          hideStudentProgress:
            isStudentList && this.sessionDetailsStore.isAdmin,
        }"
      ...
      >
        <div class="row grid-cards mt-3">
          <div
            id="module-1"
            class="grid-card level-button-outer"
            :class="{
              completed: this.m1Status == 'completed',
              'in-progress': this.m1Status == 'in progress',
              'not-started': this.m1Status == 'not started',
            }"
          >
            <a
              v-if="this.sessionDetailsStore.isAdmin"
              class="level-button-inner module-1-unlocked"
            ></a>
            <a
              v-else
              class="level-button-inner module-1-unlocked"
              href="/game?resume=scene1_1"
            ></a>
            <p>{{ m1Status }}</p>
          </div>
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m2Status == 'completed',
              'in-progress': this.m2Status == 'in progress',
              'not-started': this.m2Status == 'not started',
            }"
          >
            <a
              v-if="
                this.sessionDetailsStore.isAdmin ||
                this.m2Status == 'not started'
              "
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m3Status == 'completed',
              'in-progress': this.m3Status == 'in progress',
              'not-started': this.m3Status == 'not started',
            }"
          >
            <a
              v-if="
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m4Status == 'completed',
              'in-progress': this.m4Status == 'in progress',
              'not-started': this.m4Status == 'not started',
            }"
          >
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m5Status == 'completed',
              'in-progress': this.m5Status == 'in progress',
              'not-started': this.m5Status == 'not started',
            }"
          >
            <a class="level-button-inner thumbnail">
              <svg
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m6Status == 'completed',
              'in-progress': this.m6Status == 'in progress',
              'not-started': this.m6Status == 'not started',
            }"
          >
            <a
              v-if="
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m7Status == 'completed',
              'in-progress': this.m7Status == 'in progress',
              'not-started': this.m7Status == 'not started',
            }"
          >
            <a
              v-if="
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m8Status == 'completed',
              'in-progress': this.m8Status == 'in progress',
              'not-started': this.m8Status == 'not started',
            }"
          >
            <a
              v-if="
          ...
          <div
            ...
            class="grid-card level-button-outer"
            :class="{
              completed: this.m9Status == 'completed',
              'in-progress': this.m9Status == 'in progress',
              'not-started': this.m9Status == 'not started',
            }"
          >
            <a
              v-if="
  ...
  <div v-if="showModal">
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <p>
          If you are sure you would like to delete the user (<strong>{{
            user.username
          }}</strong
