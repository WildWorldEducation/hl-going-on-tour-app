...
export default class Scene5_8 extends Phaser.Scene {
    constructor() {
        super('Scene5_8');
    }
    preload() {
        ...
        this.load.image('bg3', 'assets/Images/5_Level3/hold-tablet.png');
    }

    create() {
        console.log('5-8');
        // Video.
        const background = this.add.image(0, 0, 'bg3').setOrigin(0);
        ...
        this.instructionText = this.add.rexBBCodeText(-100, 75, 
            `
