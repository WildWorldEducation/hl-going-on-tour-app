...
export default class Scene7_9 extends Phaser.Scene {
    constructor() {
        super('Scene7_9');
    }
    preload() {
        ...
        // Video.
        this.load.video('vid7_9', '/assets/Videos/7_Level4/Scene7_9-vid.mp4');
    ...
    create() {
        ...
        // Video
        this.vid = this.add.video(0, 0, 'vid7_9');
        ...
        this.tileBg.fillRoundedRect(-30, 0, 675, 150, 32);
        this.tileText = this.add.text(75, 75, "The Feel Good Chemical",
        ...
        nextBtn.on('pointerdown', function () {
            this.scene.start("Scene7_10", { music: this.music });
        }, this);
