...
export default class Scene7_28 extends Phaser.Scene {
    constructor() {
        super('Scene7_28');
    }
    preload() {
    ...
    create() {
        ...
        // Video
        this.vid = this.add.video(0, 0, 'vid7_28');
        ...
        this.tileBg.fillRoundedRect(-30, 0, 320, 150, 32);
        this.tileText = this.add.text(75, 75, "Real Talks",
