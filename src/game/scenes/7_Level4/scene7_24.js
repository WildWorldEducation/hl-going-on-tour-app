...
export default class Scene7_24 extends Phaser.Scene {
    constructor() {
        super('Scene7_24');
    }
    preload() {
        ...
        // Video.
        this.load.video('vid7_24', 'assets/Videos/7_Level4/Scene7_24-vid.mp4');
    ...
    create() {
        ...
        // Video
        this.vid = this.add.video(0, 0, 'vid7_24');
        ...
        this.tileBg.fillRoundedRect(-30, 0, 620, 150, 32);
        this.tileText = this.add.text(75, 75, "Welcome to the X-Games!",
