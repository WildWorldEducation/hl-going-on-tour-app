...
export default class Scene7_21 extends Phaser.Scene {
    constructor() {
        super('Scene7_21');
    }
    preload() {
        ...
        this.load.image('bg-7-21', 'assets/Images/7_Level4/Backgrounds/background-5.jpg');
        this.load.image('cross-arm-person', '/assets/Images/7_Level4/sprite/cross-arm-person.png');
        ...
        this.load.image('15-minute', 'assets/Images/7_Level4/sprite/time-clock-yellow/15-minutes.png');
        this.load.image('30-minute', 'assets/Images/7_Level4/sprite/time-clock-yellow/30-minutes.png');
        this.load.image('45-minute', 'assets/Images/7_Level4/sprite/time-clock-yellow/45-minutes.png');
        this.load.image('60-minute', 'assets/Images/7_Level4/sprite/time-clock-yellow/60-minutes.png');
        this.load.image('75-minute', 'assets/Images/7_Level4/sprite/time-clock-yellow/75-minutes.png');
        this.load.image('90-minute', 'assets/Images/7_Level4/sprite/time-clock-yellow/90-minutes.png');
        // - text pointer sprite -
    ...
    create() {
        ...
        // Cross arm person
        const crossArmPerson = this.add.sprite(390, 760, 'cross-arm-person').setScale(0.7);
        // bubble text
        ...
        this.clock15m = this.add.sprite(clockX, clockY, '15-minute').setScale(scale).setAlpha(0);
        this.clock30m = this.add.sprite(clockX, clockY, '30-minute').setScale(scale).setAlpha(0);
        this.clock45m = this.add.sprite(clockX, clockY, '45-minute').setScale(scale).setAlpha(0);
        this.clock60m = this.add.sprite(clockX, clockY, '60-minute').setScale(scale).setAlpha(0);
        this.clock75m = this.add.sprite(clockX, clockY, '75-minute').setScale(scale).setAlpha(0);
        this.clock90m = this.add.sprite(clockX, clockY, '90-minute').setScale(scale).setAlpha(0);
        ...
        */
        ...
        nextBtn.on('pointerdown', function () {
            ...
            this.formUtil.hideElement("scene7_21-range-input");
    ...
    update() {
        ...
        if (this.formUtil.getRangeValue('timeSpend') !== this.inputValue) {
            this.inputValue = this.formUtil.getRangeValue('timeSpend');
            // change time on the clock
            this.textTime.setText(`[b]${this.inputValue} \nmin[/b]`);
