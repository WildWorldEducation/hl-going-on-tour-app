...
export default class Scene7_17 extends Phaser.Scene {
    constructor() {
        super('Scene7_17');
    }
    preload() {
        ...
        // Video.
        this.load.video('vid7_17', 'assets/Videos/7_Level4/Scene7_17-vid.mp4');
    ...
    create() {
        ...
        // Video
        this.vid = this.add.video(0, 0, 'vid7_17');
        ...
        this.tileBg.fillRoundedRect(-30, 0, 740, 150, 32);
        this.tileText = this.add.text(75, 75, "Where Do You Spend Your Time?",
