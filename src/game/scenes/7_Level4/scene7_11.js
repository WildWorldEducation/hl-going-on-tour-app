...
export default class Scene7_11 extends Phaser.Scene {
    constructor() {
        super('Scene7_11');
    }
    init(data) {
    ...
    preload() {
        ...
        // Video.
        this.load.video('vid7_11', '/assets/Videos/7_Level4/Scene7_11-vid.mp4');
        // Music.
    ...
    create() {
        ...
        // Video
        this.vid = this.add.video(0, 0, 'vid7_11');
