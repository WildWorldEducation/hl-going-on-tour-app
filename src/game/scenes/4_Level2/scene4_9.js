...
export default class Scene4_9 extends Phaser.Scene {
    ...
    create() {
        ...
        header.fillRoundedRect(960 - 740, 150, 1520, 190, 72);
        var headerText = this.add.text(960 - 740 + (1520 / 2), 240,
...
seconds! Who do you think held the record before Justin Bieber?`,
        ...
        var btn1Text = this.add.text(50, 42, "A. Taylor Swift", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
        btn1Text.setOrigin(0).setScale(0.5)
        btn1Text.alpha = 1
        var btn1 = this.add.container(960 - (690 / 2), 380, [btn1Graphic, btn1Text, btn1Border]);
        ...
        btn2Border.setAlpha(0)
        var btn2Text = this.add.text(50, 42, "B. Drake", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
        btn2Text.setOrigin(0).setScale(0.5)
        btn2Text.alpha = 1
        var btn2 = this.add.container(960 - (690 / 2), 540, [btn2Graphic, btn2Text, btn2Border]);
        ...
        btn3Border.setAlpha(0)
        var btn3Text = this.add.text(50, 42, "C. Maroon 5", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
        btn3Text.setOrigin(0).setScale(0.5)
        btn3Text.alpha = 1
        var btn3 = this.add.container(960 - (690 / 2), 700, [btn3Graphic, btn3Text, btn3Border]);
