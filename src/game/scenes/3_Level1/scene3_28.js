...
so it's not dangerous.`)
        ...
        var progressBarCircle2 = this.add.sprite(560 + (114 * 1 + 35), 980, 'circle-empty').setOrigin(0.0)
        var progressBarCircle3 = this.add.sprite(560 + (114 * 2 + 35), 980, 'circle-empty').setOrigin(0.0)
        var progressBarCircle4 = this.add.sprite(560 + (114 * 3 + 35), 980, 'circle-empty').setOrigin(0.0)
