...
export default class Scene3_28 extends Phaser.Scene {
    ...
    preload() {
        ...
        // Video.
        this.load.video('myth-vid', 'assets/Videos/3_Level1/myth-vid.mp4', true);
    }
...
so it's not dangerous.`,
        ...
        btnGraphic.on('pointerdown', () => {
            if (!isAnswer) {
                ...
                nextBtn.alpha = 1;
                vid.play(false);
                this.btnText.setText(`[size=105][b]Myth[/b]
...
so it's not dangerous`)
            ...
            // an animation for showing next button
            isAnswer = !isAnswer
        });
        ...
        const bullet2 = this.add.sprite(bulletsX + 110, bulletsY, 'empty-bullet').setScale(0.4);
