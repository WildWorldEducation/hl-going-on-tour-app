...
export default class Scene3_16 extends Phaser.Scene {
    ...
    create() {
        ...
        // // --> PLAY/PAUSE question Music Section <-- // //
        ...
        // // -->End Of PLAY/PAUSE question Music Section <-- // //
        ...
        const start4 = this.add.sprite(570, 116, 'star').setOrigin(0.5).setScale(0.17);
...
and select to which music genre this song belongs to.`,
        ...
        */
        ...
        var btn1Text = this.add.text(30, 50, "A. Country", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
        ...
        var btn2Text = this.add.text(30, 50, "B. Rock", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
        ...
        var btn3Text = this.add.text(30, 50, "C. Jazz", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
        ...
        var btn4Text = this.add.text(30, 50, "D. Hip Hop", { fontFamily: "Arial", fontSize: "72px", fill: "#000000" });
