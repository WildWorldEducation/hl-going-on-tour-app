...
export default class Scene3_40 extends Phaser.Scene {
    constructor() {
        super('Scene3_40');
    }
    ...
    create() {
        ...
        const progressText = this.add.rexBBCodeText(0, 0, '3/5', { fontFamily: "Arial", fontSize: "84px", color: '#000000', align: "center" });
        ...
        LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(44), false);
        ...
        this.tweens.addCounter({
            ...
            onUpdate: function (tween) {
                ...
                LoadingGraphic.lineStyle(16, 0xbcc933, 1);
                // circle arc is a part of circle calculate by r*delta(phi) with phi is the degree or rad 
                LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(-90 + 72 * 2 + t), false);
                LoadingGraphic.strokePath();
            }
        });
        ...
        nextBtn.on('pointerdown', function () {
            this.scene.start("Scene3_41", { music: this.music });
        }, this);
        ...
        answerGraphic.fillStyle(0xc92e2e, 0.85);
        answerGraphic.fillRoundedRect(0, 0, 630, 145, 20);

        const answerText = this.add.rexBBCodeText(315, 77.5, "[b]Myth[/b]", { fontFamily: "Arial", fontSize: "85px", fill: "#ffffff" });
        answerText.setOrigin(0.5).setScale(0.5)
        const answerBtn = this.add.container(1000, 890, [answerGraphic, answerText]);
        ...
        */
        btn1.on('pointerdown', function () {
            ...
            this.textOnSign.setText("[size=79]There isn`t even water in vaping \ncartridges. They[b] are filled with \nliquids that contain hundreds of \nchemicals, nicotine and fake \nflavorings.[/b][/size]");
            // Showing next button
            nextBtn.setAlpha(1);
        }, this);
