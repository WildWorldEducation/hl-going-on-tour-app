...
export default class Scene3_22 extends Phaser.Scene {
    constructor() {
        super('Scene3_22');
    }
    ...
    preload() {
        ...
        // Video.
        this.load.video('vid3-9', 'assets/Videos/3_Level1/scene3-vid9.mp4');
    }
    ...
    create() {
        ...
        // Video.
        const vid = this.add.video(0, 0, 'vid3-9');
        vid.setOrigin(0)
        vid.play();
