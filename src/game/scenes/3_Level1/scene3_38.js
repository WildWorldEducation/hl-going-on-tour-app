...
export default class Scene3_38 extends Phaser.Scene {
    constructor() {
        super('Scene3_38');
    }
    ...
    create() {
        ...
        const progressText = this.add.rexBBCodeText(0, 0, '1/5', { fontFamily: "Arial", fontSize: "84px", color: '#000000', align: "center" });
        ...
        this.tweens.addCounter({
            ...
            onUpdate: function (tween) {
                ...
                LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(-90 + t), false);
        ...
        this.textOnSign = this.add.rexBBCodeText(960, 640,
            `Musicians always drink
alcohol and vape on tour.`,
        ...
        */
        btn1.on('pointerdown', function () {
            ...
            this.textOnSign.setText("Many musicians and bands\n choose [b]not to drink or use \nvapes[/b] on tour.");
            // Showing next button
            nextBtn.setAlpha(1);
        }, this);
