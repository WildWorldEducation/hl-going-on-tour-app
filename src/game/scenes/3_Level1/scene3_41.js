...
export default class Scene3_41 extends Phaser.Scene {
    constructor() {
        super('Scene3_41');
    }
    ...
    create() {
        ...
        const progressText = this.add.rexBBCodeText(0, 0, '4/5', { fontFamily: "Arial", fontSize: "84px", color: '#000000', align: "center" });
        ...
        LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(116), false);
        ...
        this.tweens.addCounter({
            ...
            onUpdate: function (tween) {
                ...
                LoadingGraphic.lineStyle(16, 0xbcc933, 1);
                // circle arc is a part of circle calculate by r*delta(phi) with phi is the degree or rad 
                LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(-90 + 72 * 3 + t), false);
                LoadingGraphic.strokePath();
            }
        });
