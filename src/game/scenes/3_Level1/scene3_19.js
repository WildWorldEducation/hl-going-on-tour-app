...
export default class Scene3_19 extends Phaser.Scene {
    constructor() {
        super('Scene3_19');
    }
    ...
    preload() {
        ...
        this.load.image('text-card3-14', 'assets/Images/3_Level1/text-card2.png');
        // Video.
        this.load.video('vid3-6', 'assets/Videos/3_Level1/scene3-vid6.mp4');
    }
    ...
    create() {
        ...
        // Video.
        const vid = this.add.video(0, 0, 'vid3-6');
        vid.setOrigin(0)
        vid.play();
        ...
        nextBtn.on('pointerdown', function () {
            this.scene.start("Scene3_20", { music: this.music });
        }, this);
