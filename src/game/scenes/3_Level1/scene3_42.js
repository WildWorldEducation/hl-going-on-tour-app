...
export default class Scene3_42 extends Phaser.Scene {
    ...
    create() {
        ...
        const progressText = this.add.rexBBCodeText(0, 0, '5/5', { fontFamily: "Arial", fontSize: "84px", color: '#000000', align: "center" });
        ...
        LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(188), false);
        ...
        this.tweens.addCounter({
            ...
            onUpdate: function (tween) {
                ...
                LoadingGraphic.lineStyle(16, 0xbcc933, 1);
                // circle arc is a part of circle calculate by r*delta(phi) with phi is the degree or rad 
                LoadingGraphic.arc(500, 132, 75, Phaser.Math.DegToRad(-90), Phaser.Math.DegToRad(-90 + 72 * 4 + t), false);
                LoadingGraphic.strokePath();
            }
        });
        ...
        */
        btn1.on('pointerdown', function () {
            ...
            this.textOnSign.setText("[b]Water helps the vocal \nchords,[/b] and it helps keep \nthe body healthy overall.");
            // Showing next button
            nextBtn.setAlpha(1);
        }, this);
        ...
        btn2.on('pointerdown', function () {
            ...
            // Change question text to answer text
            this.textOnSign.setText("Her vocal cords are [b]insured \nfor tens of millions[/b] \nof dollars.");
            // Showing next button
            nextBtn.setAlpha(1);
        }, this);
