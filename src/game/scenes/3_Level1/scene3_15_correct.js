...
export default class Scene3_15_correct extends Phaser.Scene {
    constructor() {
        super('Scene3_15_correct');
    }
    ...
    create() {
        ...
        const star1 = this.add.sprite(285, 116, 'star').setOrigin(0.5).setScale(0.17);
