...
export default class Scene8_6 extends Phaser.Scene {
    constructor() {
        super('Scene8_6');
    }
    preload() {
        ...
        // Video.
        this.load.video('vid8_6', 'assets/Videos/8_Level5/Scene8_6-vid.mp4');
    ...
    create() {
        ...
        // Video
        this.vid = this.add.video(0, 0, 'vid8_6');
        ...
        this.tileBg.fillRoundedRect(-30, 0, 530, 150, 32);
        this.tileText = this.add.text(75, 75, "Reaching Success!",
        ...
        nextBtn.on('pointerdown', function () {
            this.scene.start("Scene8_7", { music: this.music });
        }, this);

        // Back button
        const backBtn = new BackButton(this, -60, 500, 'next-arrow', this.nextBtnAudio);
        backBtn.on('pointerdown', function () {
            this.scene.start("Scene8_5");
        }, this);
