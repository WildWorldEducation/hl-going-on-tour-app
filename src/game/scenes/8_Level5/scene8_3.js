...
export default class Scene8_3 extends Phaser.Scene {
    constructor() {
        super('Scene8_3');
    }
    preload() {
    ...
    create() {
        ...
        */
        ...
        this.formUtil.showElement("scene8_3-book");
        this.formUtil.scaleToGameW("scene8_3-book", .8);
        ...
        this.instructionText = this.add.rexBBCodeText(90, 17,
            `
             Decision making and self-awareness 
             are important factors to your success.


             What would you rather do in your free
             time? BTW there is no right or wrong
             answer, just your truth.
             •  Hang out with friends
             •  Play video games
             •  Play sports, skate or do something
                active
             •  Read a book, magazine or comic
             •  Create art or music, or listen to 
                music
             •  Or something else
            `,
        ...
        nextBtn.on('pointerdown', function () {
            let answer = document.getElementById('scene8_3-book').value;
            // If user have not typed the answer process to failed screen
            // Else process to next scene
            if (answer.length === 0) {
                this.formUtil.hideElement('scene8_3-book');
                ...
                this.formUtil.hideElement('scene8_3-book');
                this.scene.start("Scene8_4", { music: this.music });
            }
        }, this);
